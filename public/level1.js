...
function updateFall(delta) {
  ...
  if (fallElapsed >= 2.35) {
    sessionStorage.setItem('timberCampaignLevel', '2');
    window.location.assign('/level/2');
  }
}
...
function finishGame(result) {
  ...
  if (result === 'survived') {
    ...
    endTitle.textContent = 'LEVEL 1 COMPLETE.';
    endCopy.textContent = 'The stun gun recharges as the void pulls you toward the laboratory.';
